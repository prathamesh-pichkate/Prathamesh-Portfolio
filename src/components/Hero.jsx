      ...
      <div className="flex flex-col justify-center items-center h-full text-center">
        ...
        <div className="flex flex-col justify-center items-center">
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="text-2xl sm:text-3xl md:text-4xl font-bold p-2 whitespace-nowrap tracking-tight"
          >
            Prathamesh Pichkate
          </motion.h1>
          <motion.h3
            ...
            initial="hidden"
            animate="visible"
            className="text-lg sm:text-xl md:text-2xl font-thin tracking-tight"
          >
